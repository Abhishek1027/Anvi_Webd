            ...
            <div className="flex flex-col text-white">
              <div className="flex my-4 w-2/3 lg:w-3/4">
                ...
                <div className="flex flex-col">
                  ...
                  <p className="text-gray-400">
                    Profound Builders, Kondapur, Hyderabad
                  </p>
                </div>
              </div>
              ...
              <div className="flex my-4 w-2/3 lg:w-1/2">
                ...
                <div className="flex flex-col">
                  ...
                  <p className="text-gray-400">Cell: 9876543210</p>

                  <div className="mt-5">
                    <h2 className="text-2xl">Send an E-mail</h2>
                    <p className="text-gray-400">info@anvi.co</p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex my-4 w-2/3 lg:w-1/2">
                <a
                  href="https://twitter.com/ENLIGHTENEERING"
                  target="_blank"
                  rel="noreferrer"
